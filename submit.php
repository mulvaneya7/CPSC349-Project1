...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header -->
    <div class="jumbotron">
        <h1 class="display-4">Welcome to Foodies!</h1>
        <p class="lead">Create your own recipe cards to share with the world!</p>
    </div>
        ...
        <div class="container">
            <div class ="row justify-content-center align-items-center">
                ...
                <div class="card border-warning" style="width: 18rem;">
                    ...
                    <div class="input-group mb-3">
                        <textarea class="form-control" aria-label="With textarea" placeholder="your recipe..." name="recipe"></textarea>
                    </div>
